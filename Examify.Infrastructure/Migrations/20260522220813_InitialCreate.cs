        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassagesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalParts = table.Column<int>(type: "int", nullable: false, defaultValue: 3),
                    TotalQuestions = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    TimeLimitSeconds = table.Column<int>(type: "int", nullable: false, defaultValue: 3600),
                    Difficulty = table.Column<int>(type: "int", nullable: false),
                    IsFullTest = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListeningQuestions_Exercises_ExerciseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReadingQuestions_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpeakingQuestions_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecommendedTimeMinutes = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WritingQuestions_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalScore = table.Column<short>(type: "smallint", nullable: true),
                    ReadingSubmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ListeningSubmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    WritingSubmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SpeakingSubmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointEarned = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FullTestSessions_ListeningSubmissionId",
                table: "FullTestSessions",
                column: "ListeningSubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_FullTestSessions_ReadingSubmissionId",
                table: "FullTestSessions",
                column: "ReadingSubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_FullTestSessions_SpeakingSubmissionId",
                table: "FullTestSessions",
                column: "SpeakingSubmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_FullTestSessions_UserId",
                table: "FullTestSessions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_FullTestSessions_WritingSubmissionId",
                table: "FullTestSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListeningQuestions_ExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingQuestions_ExerciseId",
                table: "ReadingQuestions",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_SpeakingQuestions_ExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WritingQuestions_ExerciseId",

...
namespace Examify.Infrastructure.Migrations
{
    ...
    [Migration("20260626204436_UpdateSessionAnswerIndexWithFilter")]
    partial class UpdateSessionAnswerIndexWithFilter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Examify.Core.Entities.FullTestSession", b =>
                {
                    ...
                    b.Property<int>("ListeningTimeSpent")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ReadingTimeSpent")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SpeakingTimeSpent")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WritingTimeSpent")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Examify.Core.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
